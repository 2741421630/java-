...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 ...
 <center>
     ...
     <form action="bookServlet?method=getBooks" method="post">
         ...
         <p>每页显示:<input type="text" name="pageSize" size="1">条记录<br></p>
 ...
 <br>
  <table cellspacing="10" cellpadding="0">
   ...
   <c:forEach items="${requestScope.page.list}" var="book">
    <tr>
        <td><a href="bookServlet?method=getBook&id=${book.id}&pageNo=${requestScope.page.pageNo}">${book.title}</a></td>
     <td>${book.author}</td>
     <td>${book.price}</td>
     <td>
         <a href="bookServlet?method=addToCart&id=${book.id}&pageNo=${requestScope.page.pageNo}&title=${book.title}">加入购物车
         </a>
     </td>
    </tr>
   </c:forEach>
     ...
     <%-- 分页条的显示--%>
     共${requestScope.page.totalIteamCount}条记录&nbsp;&nbsp;
