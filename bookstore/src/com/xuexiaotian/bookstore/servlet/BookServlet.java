package com.xuexiaotian.bookstore.servlet;

import com.google.gson.Gson;
import com.xuexiaotian.bookstore.entity.*;
import com.xuexiaotian.bookstore.service.AccountService;
import com.xuexiaotian.bookstore.service.BookService;
import com.xuexiaotian.bookstore.service.UserService;
...
public class BookServlet extends HttpServlet {
    ...
    //库存是否充足验证(购物车中某个商品的数量大于该商品的库存数量)
    ...
    protected void addToCart(HttpServletRequest request,
        ...
        if (id > 0){
            ...
            //7.失败,进入错误页(error-1.jsp)
            response.sendRedirect(request.getContextPath()+"error-1.jsp");
        }
    }
    //查询单个的商品分页信息,并且转发到book.jsp页面上去显示
    protected void getBook(HttpServletRequest request,
     ...
     //查询所有的商品分页信息,并且转发到books.jsp页面上去显示
    protected void getBooks(HttpServletRequest request,
        ...
        try {
            pageNo = Integer.parseInt(pageNoStr);      //处理数字格式异常
        } catch (NumberFormatException e) { }
        try {
